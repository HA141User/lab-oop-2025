...
public class TypeRacer {
    ...
    private String[] wordsToTypeList = {
            "Pada dasarnya semua orang belajar coding itu dari 0, yang membedakan progres kita adalah konsisten",
            "Tutorial ngoding tanpa menggunakan ai",
            "Kalau ada sumur di ladang, bolehlah kita menumpang mandi. Kalau ada umurku panjang, bolehlah kita berjumpa lagi. hehe asiik",
            "Kenangan yang indah bagi programmer adalah berhasil membuat kode hello world",
            "jadi kita bakal main warden fire ball disini, kita make invicible spell di sini, sini, dan sini. Buum , keren ga guys . yes Tenkyu"
    };
    ...
    public void addResult(String name, int finishTime) { // Gunakan tipe data Typer
    ...
    public void startRace() {
        ...
        // Jalankan semua thread kontestan
